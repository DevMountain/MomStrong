...
class MomStrongTabBarController: UITabBarController {
    ...
    override func viewDidLoad() {
        ...
        progress.tabBarItem = UITabBarItem(title: "Progress", image: #imageLiteral(resourceName: "Checkmark_fill"), tag: 0)
        atHome.tabBarItem = UITabBarItem(title: "AtHome", image: #imageLiteral(resourceName: "Home_Active"), tag: 1)
        gymRat.tabBarItem = UITabBarItem(title: "GymRat", image: #imageLiteral(resourceName: "Gym_Active"), tag: 2)
